...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-j-nncnk.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-j-nncnk.containers.anotherwebservice.com/
...
```
git clone git@github.com:naeemark/container-j-nncnk.git
cd container-j-nncnk
```
...
```
docker attach container-j-nncnk
```
